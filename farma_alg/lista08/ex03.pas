...
function verifica_subseq(var v: vetor; n, tam_subseq, i, j: longint): boolean;
var cont: longint;
begin
	cont := 0;
...
var i, j, posicao_achou, falta_comparar: longint;
begin
	posicao_achou := 0;	
	i := 1;
	falta_comparar := n - tam_subseq;
	...
	begin
		...
		begin
			if (v[i] = v[j]) and verifica_subseq(v, n, tam_subseq, i, j) then
					posicao_achou := i;
			j := j + 1;
		end;
		i := i + 1;
